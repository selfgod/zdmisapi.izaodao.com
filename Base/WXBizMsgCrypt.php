...
require_once __DIR__ . "/WorkWechat/lib/sha1.php";
require_once __DIR__ . "/WorkWechat/lib/xmlparse.php";
require_once __DIR__ . "/WorkWechat/lib/pkcs7Encoder.php";
require_once __DIR__ . "/WorkWechat/lib/errorCode.php";
/**
 * 1.第三方回复加密消息给公众平台；
